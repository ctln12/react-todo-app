...
class TodoList extends Component {
  constructor(props){
    super(props);
    this.state = { todos: [{ content: "Do morning mediation", id: uuidv4(), completed: true }, { content: "Start learning React", id: uuidv4(), completed: false }, { content: "Code a todo app", id: uuidv4(), completed: false }] };
